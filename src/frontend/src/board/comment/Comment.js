...
function Comment(props) {
	...
	const updateComment = async () => {
		...
		await axios.patch(`http://localhost:8081/board/${boardId}/comment/update/${commentId}`, req, {headers: headers})
		.then((resp) => {
	...
	const deleteComment = async () => {
		await axios.delete(`http://localhost:8081/board/${boardId}}/comment/delete/${commentId}`, {headers: headers})
			.then((resp) => {
